// Package main generated by 'freedom new-project gohtml'
package main

import (
	_ "gohtml/adapter/controller" //Implicit initialization controller
	_ "gohtml/adapter/repository" //Implicit initialization repository
	"gohtml/config"
	"gohtml/web/tmplfuncs"
	"time"
